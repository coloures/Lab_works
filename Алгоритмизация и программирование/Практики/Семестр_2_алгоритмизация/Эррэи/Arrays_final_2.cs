...
namespace ConsoleApplication19
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (!trying.Process(ref arr, number))
                {
                    break;
                }
            }
    ...
    class Types_of_arrays
    {
        ...
        public bool Process(ref Array arr_out, int number)
        {
            if (Type == "array")
            {
                switch (number)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Array.Clear(arr_out, 0, arr_out.Length);
                        if (type_of_arr == "char") 
                        {
                            arr_out = Array.CreateInstance(typeof(char), arr.Length);
                        }
                        else if (type_of_arr == "int")
                        {
                            arr_out = Array.CreateInstance(typeof(int), arr.Length);
                        }
                        else if (type_of_arr == "bool")
                        {
                            arr_out = Array.CreateInstance(typeof(bool), arr.Length);
                        }
                        else if (type_of_arr == "string")
                        {
                            arr_out = Array.CreateInstance(typeof(string), arr.Length);
                        }
