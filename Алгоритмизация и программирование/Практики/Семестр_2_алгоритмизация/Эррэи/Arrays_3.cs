                ...
                switch (number)
                {
                    ...
                    case 2:
                        if (type_of_arr == "bool")
                        {
                            ...
                            Console.WriteLine($"Индекс элемента {what_to_find} в массиве: {arr.Length + Array.BinarySearch(arr, what_to_find)}");
                        }
                    ...
                    case 6:
                        ...
                        Console.WriteLine($"Массив уменьшен до {num} элементов");
                        break;
                    case 7:
                        Array.Sort(arr);
